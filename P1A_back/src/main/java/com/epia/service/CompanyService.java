...
public class CompanyService {
    ...
    private List<EvaluationItem> createDefaultEvaluationItems(String companyId) {
        ...
        item1.law = "개인정보 보호법 제15조(개인정보의 수집ㆍ이용), 개인정보 보호법 제22조(동의를 받는 방법) 1천만원 이하 과태료";
        items.add(item1);
        ...
        item3.no = "1.1.3";
        item3.item = "수집하는 개인정보 항목은 목적에 부합한 최소한의 항목으로 구성되어 있습니까? (입증 책임은 개인정보 처리자에게 있다.)";
        ...
        item5.no = "1.1.5";
        item5.item = "마케팅(광고·판매 권유) 목적으로 고객의 개인정보를 사용하려는 경우, 법령에 근거해 처리하거나 다른 개인정보와 구분하여 별도로 동의를 받고 있습니까?";
        ...
        item5.law = "개인정보 보호법 제22조제1항(동의를 받는 방법) 1천만원 이하의 과태료";
        items.add(item5);
        ...
        item6.no = "1.1.6";
        item6.item = "고객의 사생활을 침해할 위험이 있는 *민감정보를 수집할 경우 다른 개인정보와 별도로 동의 받거나, 법령의 근거하여 처리하고 있는가?";
        ...
        item7.no = "1.1.7";
        item7.item = "고객의 고유식별정보를 수집하는 경우 법률에 근거하여 별도의 동의를 받고 있는가?";
        ...
        item8.no = "1.1.8";
        item8.item = "고객의 주민등록번호를 수집하는 경우 법적 근거가 있을 경우에만 수집하고 있으며, 주민등록번호를 이용하지 않고도 회원가입을 할 수 있게 계획하고 있는가?";
        ...
        item10.no = "1.1.10";
        item10.item = "고객의 동의없이 처리하는 경우 개인정보 처리방침에 공개하고 있습니까?";
        ...
        item12.no = "1.3.1";
        item12.item = "고객의 개인정보를 제3자에게 제공하는 경우 법령에 근거하여 제공하거나 정보주체의 별도 동의를 받아 이용·제공하고 있습니까?";
        item12.riskFactors = "고객의 개인정보를 제3자 제공할 때 다른 법령의 근거하여 이용하지 않거나 별동의 동의를 받지않을 경우 고객의 권리를 침행할 수 있다.";
        ...
        item13.law = "개인정보 보호법 제18조제3항(개인정보의 목적 외 이용ㆍ제공 제한) 벌칙없음";
        items.add(item13);
        ...
        item16.no = "1.4.2";
        item16.item = "개인정보를 국외로 이전하는 경우 정보주체에게 국외이전에 관한 고지사항을 모두 알리고 있는가?";
        ...
        item16.law = "개인정보 보호법 제28조의8제12항(개인정보의 국외 이전) 벌칙 없음";
        items.add(item16);
        ...
        item17.no = "1.4.3";
        item17.item = "개인정보를 국외 이전하는 경우 개인정보처리방침에 국외 이전 내역을 공개하고 있는가?";
        ...
        item18.subField = "위탁";
        item18.no = "1.5.1";
        item18.item = "개인정보 처리에 관한 업무를 위탁하는 경우 업무 내용과 *수탁자(*재수탁자 포함)에 대한 사항을 고객에게 공개하고 있는가?";
        ...
        item19.no = "1.5.2";
        item19.item = "개인정보 처리에 관한 업무를 위탁받아 처리하는 자가 위탁받은 개인정보 처리 업무를 제3자에게 다시 위탁하려는 경우에는 위탁자의 동의를 받도록 계획하고 있는가?";
        ...
        item20.law = "개인정보 보호법 제21조제1항(개인정보의 파기) 3천만원 이하의 과태료";
        items.add(item20);
        ...
        item21.no = "1.6.2";
        item21.item = "고객에게 고지한 기간이 만료될 경우 지체 없이 파기하도록 구현하였는가?";
        ...
        item22.no = "1.6.3";
        item22.item = "이용목적 달성시(회원탈퇴, 동의 철회) 다른 법령에 따라 보존해야 하는 경우 해당 개인정보 또는 개인정보파일을 다른 개인정보와 분리하여 저장·관리하도록 계획하고 있는가?";
        ...
        item23.no = "1.6.4";
        item23.item = "법령에 근거하여 개인정보 또는 개인정보 파일을 분리 저장·관리한다는 사실을 개인정보처리방침을 통해 고지하고 있습니까?";
        ...
        item24.no = "2.1.1";
        item24.item = "개인정보 취급자의 책임추적성을 확보하기 위하여 유일한 식별자를 사용하고 있습니까?";
        ...
        item24.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item24);
        ...
        item25.no = "2.1.2";
        item25.item = "공유계정 사용 시 공유원칙을 준수하고 있습니까? ";
        ...
        item25.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item25);
        ...
        item26.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item26);
        ...
        item27.no = "2.1.4";
        item27.item = "비밀번호를 정기적으로 변경하고 있습니까?";
        ...
        item27.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item27);
        ...
        item28.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item28);
        ...
        item29.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item29);
        ...
        item30.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item30);
        ...
        item31.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item31);
        ...
        item32.no = "2.2.2";
        item32.item = "개인정보취급자가 정보통신망을 통해 외부에서 개인정보처리시스템에 접속하려는 경우 인증서, 보안토큰, 일회용 비밀번호, 생체인식 등 안전한 인증수단을 적용하고 있습니까?";
        ...
        item32.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item32);
        ...
        item33.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item33);
        ...
        item34.no = "2.3.1";
        item34.item = "중요한 개인정보를 저장하는 경우, 암호화하고 있습니까?";
        ...
        item34.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item34);
        ...
        item35.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item35);
        ...
        item36.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item36);
        ...
        item37.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item37);
        ...
        item38.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item38);
        ...
        item39.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item39);
        ...
        item40.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item40);
        ...
        item41.no = "2.4.3";
        item41.item = "개인정보의 오·남용, 분실·도난, 유출·위조·변조 또는 훼손 등에 대응하기 위하여 개인정보처리시스템의 접속기록을 정기적(월 1회 이상)으로 점검하도록 계획하고 있습니까?";
        ...
        item41.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item41);
        ...
        item42.no = "2.5.1";
        item42.item = "개인정보처리시스템에서 개인정보의 출력(인쇄, 화면 표시, 파일생성 등)시 용도를 특정하여 용도에 따라 출력항목을 최소화하여 출력하고 있습니까?";
        ...
        item42.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item42);
        ...
        item43.law = "개인정보 보호법 제29조(안전조치의무) 3천만 원 이하의 과태료";
        items.add(item43);
        ...
        item44.no = "3.1.1.1";
        item44.item = "텍스트를 입력할 때 자동완성을 비활성화 하여 비밀번호 또는 중요한 개인정보가 자동완성으로 제안되지 않도록 계획하고 있습니까?";
        ...
        item48.no = "3.1.4.1";
        item48.item = "영문, 숫자, 특수문자로 조합한 최소 8자리 이상의 길이로 구성된 문자열로 비밀번호를 설정하도록 계획하고 있습니까?";
        ...
        item50.no = "3.2.2.1";
        item50.item = "로그인 실패 문구에 원인을 너무 상세하게 표시하지 않도록 계획하고 있습니까?";
        ...
        item51.no = "3.2.3.1";
        item51.item = "일정시간 동안 사용되지 않는 세션 정보는 강제적으로 삭제되도록 설계하도록 계획하고 있습니까?";
        ...
        item52.no = "3.3.1.1";
        item52.item = "중요한 개인정보를 저장하는 경우, 안전한 방식으로 암호화하고 있습니까?";
        ...
        item53.no = "3.3.2.1";
        item53.item = "고객의 비밀번호, 고유식별번호, 민감정보, 바이오정보, 금융정보 등 중요도가 높은 개인정보를 인터넷 및 외부 시스템을 통해 전송 할 때는 SSL 방식 등의 암호화 통신을 하도록 계획하고 있습니까?";
        ...
        item55.no = "3.4.1.1";
        item55.item = "어드민 페이지를 사용하는 경우에는 사용자 또는 사용자 그룹에 따라 메뉴별, 기능별 접근 통제 처리를 하도록 계획하고 있습니까?";
        ...
        item57.no = "3.5.1.1";
        item57.item = "개인정보처리시스템에 대한 비정상적인 접근을 방지하기 위하여 장기 미접속시 계정잠금을 통한 보호 대책이 적용되도록 계획하고 있습니까?";
        ...
        item58.no = "3.5.1.2";
        item58.item = "개인정보처리시스템에 대한 비정상적인 접근을 방지하기 위하여 장기 미접속시 동시접속제한을 통한 보호 대책이 적용되도록 계획하고 있습니까?";
