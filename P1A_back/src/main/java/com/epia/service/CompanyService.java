...
public class CompanyService {
    ...
    private List<EvaluationItem> createDefaultEvaluationItems(String companyId) {
        ...
        item1.description = """
                ▷ 개인정보 수집 이용 동의서 작성시 아래 내용을 명확히 고지해야 한다.
                ...
                ▷ 위의 항목에 변경이 있을 경우 이를 알리고 동의를 받아야 한다.
                """;
        ...
        item3.description = """
                ▷ 수집 목적을 달성하기 위해 필수적으로 필요한 개인정보 외의 항목을 수집해서는 안 된다.
                
                ▷ 최소 수집이라는 입증 책임은 개인정보처리자에게 있으므로 서비스의 본질적 기능을 위해 반드시 필요한 정보만을 수집해야 한다.
        ...
        item4.description = """
                ▷ 필수적으로 수집해야 하는 개인정보 외의 항목을 수집하는 경우에는 별도 동의를 받아야 한다.
                
                ▷ 여기서 '필수적으로 수집'은 회원가입, 재화 또는 서비스 제공을 위해 필요한 개인정보를 말한다.
                
                ▷ 선택 항목으로 개인정보를 수집하는 경우 수집에 거부할 수 있다는 사실을 구체적으로 알려야 한다.
                
                ▷ 또한, 선택 항목에 동의하지 않는다는 이유로 정보주체에게 재화 또는 서비스 제공(회원가입 포함)을 거부해서는 안 된다.
                """;
        ...
        item5.description = """
                ▷ 재화 또는 서비스 제공을 위하여 필요한 최소한의 개인정보 => 필수 항목
                
                ▷ 마케팅 등을 목적으로 필요한 개인정보 => 선택 항목
                
                ▷ 선택 항목에 동의하지 않는다는 이유로 재화 또는 서비스의 제공을 거부해서는 안 된다.
                """;
        ...
        item6.description = """
                ▷ 민감정보의 종류
                  ...
                  (2) 벌금 이상의 형의 선고·면제 및 선고유예, 보호감호, 치료감호, 보호관찰, 선고유예의 실효, 집행유예의 취소, 벌금 이상의 형과 함께 부과된 몰수, 추징, 사회봉사명령, 수강명령 등의 선고 또는 처분 등 범죄경력에 관한 정보
                  (3) 개인의 신체적, 생리적, 행동적 특징에 관한 정보로서 특정 개인을 알아볼 목적으로 일정한 기술적 수단을 통해 생성한 정보
                  (4) 인종이나 민족에 관한 정보
                
                ▷ 민감정보를 수집할 경우 아래 항목에 대해 고지 후 동의를 받아야 한다.
                
                ▷ 법령의 근거 등으로 동의가 불필요한 경우, 그 내용을 안내해야 한다.
                """;
        ...
        item7.description = """
                ▷ 고유식별정보의 종류
                  (1) 주민등록번호 (원칙적으로 처리 금지 - 1.1.8 참고)
                  (2) 여권번호
                  (3) 운전면허번호
                  (4) 외국인등록번호
                
                ▷ 고유식별정보를 수집할 경우 아래 항목에 대해 고지 후 동의를 받아야 한다.
                """;
        ...
        item8.description = """
                ▷ 주민등록번호는 원칙적으로 처리 금지한다. 법령에서 규정한 예외사유 해당되는 경우에만 처리가 가능하다.
                
                ▷ 주민등록번호 처리금지 예외 사유
                  (1) 법률·대통령령·국회규칙·대법원규칙·헌법재판소규칙·중앙선거관리위원회규칙 및 감사원규칙에서 구체적으로 주민등록번호의 처리를 요구하거나 허용한 경우
                  (2) 정보주체 또는 제3자의 급박한 생명, 신체, 재산의 이익을 위하여 명백히 필요하다고 인정되는 경우
                  (3) (1), (2)에 준하여 주민등록번호 처리가 불가피한 경우로서 보호위원회가 고시로 정하는 경우
                
                ▷ 회원가입시 주민등록번호를 이용하지 않고 회원가입 할 수 있는 방법을 제공해야 한다.
                """;
        ...
        item9.description = """
                ▷ 만 14세 미만의 아동의 개인정보를 수집하는 경우 아동의 동의와 법정 대리인의 동의를 모두 받아야 한다.
                
                ▷ 법정대리인의 동의 받는 방법: 휴대폰인증, 신용카드인증, 공인인증서 등 (주민등록번호 제외)
                
                ▷ 법정대리인의 동의를 받은 경우 아동의 동의를 중복하여 받을 필요 없다.
                
                ▷ 개인정보 수집이용동의에 따른 적법 근거를 입증할 수 있도록 법정대리인에게 동의 받은 기록을 남기고 보존해야 한다.
                  - 기록 사항: 동의일시, 동의항목, 동의자(법정대리인이 동의한 경우 법정대리인 정보), 동의 방법
                  - 보존 기간: 회원탈퇴 등으로 인한 해당 개인정보 파기까지
                """;
        ...
        item10.description = """
                ▷ 고객의 동의 없이 법적 근거를 통해 개인정보를 처리하는 경우 처리하는 개인정보 항목과 법적근거를 개인정보 처리방침에 공개해야 한다.
                
                ▷ 고객의 동의 없이 처리할 수 있는 법률적 근거 [개인정보 보호법 제15조 1항]
        ...
        item11.description = """
                ▷ 개인정보 최소 처리의 원칙에 따라서 개인정보의 보유기간을 필요 최소한으로 정해야 한다.
                
                ▷ 필요한 기간이라는 입증책임은 개인정보처리자에게 있다.
                """;
        ...
        item12.description = """
                ▷ '제3자'란 고객과 고객에 관한 개인정보를 수집·보유하고 있는 개인정보처리자를 제외한 모든 자를 의미한다. (단, 정보주체의 대리인과 수탁자는 제외)
                
                ▷ '제공'이란 제3자에게 개인정보의 지배·관리권이 이전되는 것을 의미한다.
        ...
        item13.description = """
                ...
                ▷ 위 항목의 내용을 변경하는 경우 이를 알리고 동의를 받아야 한다.
                """;
        ...
        item14.description = """
                ▷ 개인정보 처리방침에 기재해야 하는 내용
                  <고객의 동의를 받아 개인정보를 제3자 제공할 경우>
                  1. 개인정보를 제공받는 자(제3자)
                  2. 제3자의 이용 목적
                  3. 제공하는 개인정보의 항목
        ...
        item15.description = """
                ▷ 국외 이전에서 이전은 제공(조회 포함)·처리위탁·보관을 말한다.
                
                ▷ 국외 제공·처리위탁·보관이 가능한 경우
        ...
        item16.description = """
                ▷ 개인정보를 국외 이전하는 경우 아래 5가지 사항을 고객에게 고지해야 한다.
                  (1) 이전되는 개인정보 항목
        ...
        item17.description = """
                ▷ 개인정보 처리방침에 공개해야 하는 내역
                  (1) 국외이전의 법적 근거
                  (2) 이전되는 개인정보 항목
                  (3) 개인정보가 이전되는 국가, 시기 및 방법
                  (4) 이전 받는 자의 성명 (법인인 경우에는 그 명칭과 연락처)
                  (5) 개인정보를 이전 받는 자의 개인정보 이용목적 및 보유·이용 기간
        ...
        item18.description = """
                ▷ 위탁자: 개인정보의 처리 업무를 위탁하는 개인정보처리자
                   수탁자: 개인정보 처리 업무를 위탁받아 처리하는 자
                   재수탁: 개인정보 처리 업무를 위탁받아 처리하는 자로부터 위탁받은 업무를 다시 위탁받은 제3자
                
                ▷ 개인정보 처리방침에 공개해야 하는 내역
                  (1) 위탁하는 업무의 내용
                  (2) 수탁자 (재수탁자 포함)
                  (3) 위탁시 처리되는 개인정보 항목 ※권고
                  (4) 위탁 기간 ※권고
                
                ▷ 위탁업무의 내용 또는 수탁자가 변경되는 경우 개인정보 처리방침에 지체 없이 변경 사항을 공개해야 한다.
                """;
        ...
        item19.description = """
                ▷ 수탁자는 위탁받은 개인정보의 처리 업무를 제3자에게 다시 위탁(재수탁)하려는 경우에는 위탁자의 동의를 받아야 한다.
                
                ▷ 위탁자와 수탁자는 문서화된 개인정보 처리 업무 위탁 계약이 이루어지도록 해야 한다.
        ...
        item20.description = """
                ▷ 보유기간의 경과, 개인정보의 처리 목적 달성, 가명정보의 처리 기간 경과 등 그 개인정보가 불필요하게 되었을 때에는 지체 없이 그 개인정보를 파기해야 한다.
        ...
        item22.description = """
                ▷ 개인정보를 파기하지 않고 보존해야 하는 경우에는 해당 개인정보 또는 개인정보파일을 다른 개인정보와 분리하여서 저장·관리하여야 한다.
                """;
        ...
        item24.description = """
                ▷ 개인정보처리시스템에 접속할 수 있도록 사용자 계정을 발급하는 경우, 책임 추적성이 확보될 수 있도록 개인정보취급자별로 유일하게 구분할 수 있는 식별자를 할당해야 한다.
                """;
        ...
        item25.description = """
                ▷ 개인정보처리시스템에 접근 가능한 계정은 개인정보취급자별로 발급하는 것이 원칙이다.
                
                ▷ 단, 시스템이 제공하는 고정된 계정(root 등)과 같이 기술적으로 개별 발급이 불가능한 경우 예외적으로 계정을 공유할 수 있다.
                
                ▷ 계정을 공유할 경우, 접속자를 식별할 수 있도록 접속 기록, 접근제어 시스템 등 관리 및 기술적 수단을 이용하여 공유 계정 사용 허용에 대한 내부 승인 절차를 수립하고 이를 준수한다.
                """;
        ...
        item26.description = """
                ...
                ▷ 특히, 개인정보처리시스템의 관리자 권한에 대해서는 다중요소 인증을 적용하거나 비밀번호를 복잡하게 구성하고 변경 주기를 짧게 하는 등 강화된 안전조치를 적용할 필요가 있다.
                
                ▷ 비밀번호 작성규칙 예시
                  - 조합 규칙 적용: 영문, 숫자, 특수문자 중 2종류 이상을 조합하여 최소 10자리 이상 또는 3종류 이상을 조합하여 최소 8자리 이상
                  - 변경주기 설정: 비밀번호 유효기간을 설정하여 주기적으로 변경
                  - 추측하기 쉬운 비밀번호 설정 제한: 동일한 문자 반복, 키보드 상에서 나란히 있는 문자열, 일련번호, 연속적인 숫자, 생일, 주민등록번호, 전화번호 등 추측하기 쉬운 개인정보 및 ID와 비슷한 비밀번호 사용 제한 권고
        ...
        item27.description = """
                ...
                ▷ 장기간 동일한 비밀번호를 사용하는 경우 해킹의 가능성도 높아지므로 변경 주기 등을 정하여 적용할 수 있다. 비밀번호 설정일시와 현재시간을 비교하여 비밀번호 변경기간이 도래한 경우 비밀번호를 변경할 수 있도록 안내한다.
                
                ▷ 이전과 동일한 비밀번호의 사용제한을 위해 기존에 사용한 비밀번호를 일정개수 이상 저장하여, 과거에 사용했던 비밀번호와 동일할 경우 변경을 제한한다.
                """;
        ...
        item28.description = """
                ▷ 인증 실패 횟수는 개인정보처리시스템의 특성, 위험 분석 결과 등을 고려하여 정할 수 있다 (예: 5회 등).
                
                ▷ 일정 횟수 이상 인증에 실패하여 접근이 제한된 자에게 개인정보처리시스템에 대한 접근을 재부여하는 경우에는 반드시 정당한 자인지 여부를 확인한 후 접근 제한 해제 등의 조치를 해야 한다.
                """;
        ...
        item29.description = """
                ▷ 지체 없이 해당 계정 또는 접근 권한을 변경이나 회수하는 등 필요한 조치를 취하여야 하는 경우
                  (1) 개인정보 취급자의 전보, 퇴직, 휴직 등 인사이동이 발생
                  (2) 수탁자와의 계약 변경 또는 종료 등에 따라 개인정보취급자가 변경
                  (3) 조직 변경 또는 조직 내 업무조정으로 개인정보취급자의 업무가 변경
                """;
        ...
        item30.description = """
                ▷ 접근 권한 부여 내역에는 다음과 같이 발급 과정과 이력을 확인할 수 있는 정보를 포함하여 기록하여야 한다.
                  (1) 신청자 정보
                  (2) 신청일시
                  (3) 승인자 및 발급자 정보
                  (4) 등록 정보
                ...
                ▷ 접근 권한 변경 및 말소 내역에도 관련 과정 및 이력을 확인할 수 있도록 기록하여야 한다.
                """;
        ...
        item31.description = """
                ▷ 개인정보처리시스템과 연결이 완전히 차단되어 정보의 송수신이 불가능한 상태가 되어야 하므로, 업무용 컴퓨터의 화면잠금, 화면보호기 등은 접속차단에 해당하지 않는다.
                
                ▷ 최대 접속가능 시간은 통상적인 수준(10분~60분 이내)에서 개인정보를 처리하는 방법 및 환경, 보안위험요인, 업무특성 (데이터베이스 운영·관리, 시스템 모니터링 및 유지보수 등) 등을 고려하여 환경에 맞게 정할 수 있다.
                
                ▷ 개인정보처리 시스템 정기 점검 등 특별한 상황에서 장시간 접속이 필요한 때에는 사유 및 접속기간 등 그 기록을 보관·관리하고, 작업 종료 등에 따라 장시간 접속이 불필요해진 경우에는 다시 원래의 시간으로 복원하여야 한다.
                
                ▷ 접속차단 조치 이후 다시 접속하고자 할 때에는 그 방법·절차 등이 최초의 접속 방법·절차 등과 동일한 수준 이상이 되어야 한다.
                """;
        ...
        item32.description = """
                ▷ 개인정보처리시스템에 대한 정당한 접근 권한을 가진 자(다만, 정보주체는 제외한다)가 개인정보처리자의 업무 특성 또는 필요에 따라 노트북, 업무용 컴퓨터, 모바일 기기 등으로 외부에서 정보통신망을 통해 개인정보처리시스템에 접속해야 하는 경우 계정과 비밀번호 입력 등의 식별·인증 절차 외에 추가적인 인증수단을 적용하여야 한다.
                
                ▷ 추가적으로 적용 가능한 안전한 인증수단으로는 인증서(PKI), 보안토큰, 일회용 비밀번호(OTP), 생체인증, 문자메시지, 전화인증, 소셜 로그인 등이 있다.
                
                ▷ 이용자가 아닌 정보주체의 개인정보를 처리하는 개인정보처리시스템의 경우 가상 사설망, 전용선 등 안전한 접속수단 또는 안전한 인증수단 중 하나를 선택하여 적용할 수 있다.
                """;
        ...
        item33.description = """
                ▷ 전년도 말 기준 직전 3개월간 그 개인정보가 저장·관리되고 있는 이용자(정보통신망법에 따른 정보통신서비스 제공자가 제공하는 정보통신서비스를 이용하는 자) 수가 일일평균 100만명 이상인 개인정보처리자는 다음에 해당하는 개인정보취급자의 컴퓨터 등에 대해 인터넷망 차단 조치를 해야 한다.
                  (1) 개인정보처리시스템에 대한 접근 권한을 설정할 수 있는 개인정보취급자
                  (2) 개인정보처리시스템에서 개인정보를 다운로드 또는 파기할 수 있는 개인정보취급자
                
                ▷ 「클라우드컴퓨팅 발전 및 이용자 보호에 관한 법률」 제2조제3호에 따른 클라우드컴퓨팅서비스를 이용하여 개인정보처리시스템을 구성·운영하는 경우에는 해당 클라우드컴퓨팅서비스에 대한 접속 외에 다른 인터넷의 접속을 차단하면 된다.
                
                ▷ 개인정보처리시스템에서 개인정보를 다운로드 또는 파기할 수 있는 개인정보취급자의 컴퓨터 등은 다음에 해당하는 경우 인터넷망 차단 조치를 하지 않을 수 있다.
                  (1) 위험 분석 결과에 따라 확인된 위험이 현저히 낮은 경우
                  (2) 위험을 감소시킬 수 있는 보호조치를 적용한 경우
                  ※ 예외: 민감정보, 비밀번호, 생체인식정보, 고유식별번호, 신용카드번호, 계좌번호를 다운로드 또는 파기할 수 있는 경우 인터넷망 차단 조치를 하여야 한다.
                """;
        ...
        item34.description = """
                ▷ 비밀번호, 생체인식정보 등 인증정보를 데이터베이스, 파일 등으로 저장하는 경우에는 이를 안전한 암호 알고리즘으로 암호화하여야 한다.
                
                ▷ 암호화 저장하여야 하는 이용자의 개인정보는 다음과 같다.
                  (1) 주민등록번호
                  (2) 여권번호
                  (3) 운전면허번호
                  (4) 외국인등록번호
                ...
                ▷ 이용자가 아닌 정보주체의 고유식별정보를 인터넷망 구간 및 인터넷망 구간과 내부망의 중간 지점(DMZ), 내부망에 저장하는 경우 암호화하여야 한다.
                
                ▷ 단, 내부망에 이용자가 아닌 정보주체의 주민등록번호 외 고유식별정보(여권번호, 운전면허번호, 외국인등록번호)를 저장하는 경우 암호화 미적용시 위험도 분석 결과에 따라 암호화의 적용여부 및 적용범위를 정할 수 있다.
                """;
        ...
        item35.description = """
                ▷ 인증정보 중 비밀번호를 저장하는 경우에는 복호화되지 아니하도록 해시함수 등을 통해 일방향 암호화하여야 한다.
                
                ▷ 비밀번호 일방향 암호화 시 무작위 대입공격, 레인보우 테이블 공격 등에 대응하기 위한 수단으로 솔트값 추가 등을 고려할 수 있다.
                """;
        ...
        item36.description = """
                ▷ 다음의 경우에는 안전한 암호 알고리즘으로 암호화하여야 한다.
                  (1) 비밀번호, 생체인식정보 등 인증정보를 저장 또는 정보통신망을 통하여 송·수신하는 경우
                  (2) 이용자의 개인정보 또는 이용자가 아닌 정보주체의 고유식별정보, 생체인식정보를 개인정보취급자의 컴퓨터, 모바일 기기 및 보조저장매체 등에 저장하는 경우
                  (3) 이용자의 주민등록번호, 여권번호, 운전면허번호, 외국인등록번호, 신용카드번호, 계좌번호, 생체인식정보를 저장하는 경우
                  (4) 개인정보를 정보통신망을 통하여 인터넷망 구간으로 송·수신하는 경우
                
                ▷ 사용하면 안 되는 암호화 알고리즘: DES, 3DES, MD5, SHA-1, 2TDEA, 3TDEA 등
                """;
        ...
        item37.description = """
                ...
                ▷ 암호키를 서버, 파일에 환경 변수로 저장하는 경우 평문으로 보관하여서는 안 된다.
                """;
        ...
        item38.description = """
                ▷ 비밀번호, 생체인식정보 등 인증정보를 정보통신망을 통하여 송수신하는 경우에는 통신구간 암호화 프로토콜(SSL/TLS 등), 응용프로그램을 이용한 보안서버 등 안전한 암호 알고리즘으로 암호화하여야 한다.
                
                ▷ 정보주체의 개인정보를 정보통신망을 통하여 인터넷망 구간으로 송수신하는 경우에는 안전한 암호 알고리즘으로 암호화하여야 한다.
                
                ※ '정보통신망'은 내부망과 외부망(인터넷망 등)을 포함한 모든 통신망을 의미한다.
                """;
        ...
        item39.description = """
                ...
                ▷ 아래의 경우 개인정보처리시스템에 접속한 자(다만, 정보주체는 제외한다)의 접속기록은 최소 2년 이상 보관·관리하여야 한다.
                ...
                ▷ 필수 기록 항목
                  - 식별자(ID): 개인정보처리시스템에서 접속한 자를 식별할 수 있도록 부여된 ID 등
                  - 접속 일시: 년-월-일, 시:분:초 등 접속한 시점 또는 업무를 수행한 시점
                  - 접속지 정보: 접속자 IP 주소 등 단말기 정보 또는 서버의 IP 주소
                  - 처리한 정보주체 정보: ID, 고객번호, 학번, 사번 등 개인정보취급자가 누구의 개인정보를 처리하였는지를 알 수 있는 식별정보
                  - 수행 업무: 검색, 열람, 조회, 입력, 수정, 삭제, 출력, 다운로드 등 개인정보에 대해 어떤 행위를 수행했는지 알 수 있는 구체적인 정보
                """;
        ...
        item40.description = """
                ...
                ▷ 개인정보처리시스템과 동일한 서버에 접속기록이 존재하게 될 경우에는 위·변조, 도난, 분실 등을 방지하는 것이 어려우므로 최소한 물리적으로 분리된 저장장치에 보관·백업될 수 있도록 하여야 한다.
                """;
        ...
        item41.description = """
                ▷ 개인정보처리자는 개인정보처리시스템의 접속기록을 실시간 또는 정기적으로 점검하여 비인가된 개인정보 처리, 대량의 개인정보에 대한 조회, 정정, 다운로드, 삭제, 출력 등의 비정상 행위를 탐지하고 적절한 대응조치를 할 필요가 있다.
                
                ▷ 개인정보처리자는 처리하는 개인정보의 규모 및 성격, 개인정보취급자의 수, 개인정보처리 시스템 특성 등을 고려하여 주기·방법·사후조치절차 등을 내부 관리계획을 통해 합리적으로 정하여야 한다.
                ...
                ▷ 접속기록 내 비정상 행위 예시
                  ...
                  - 접속지 정보: 인가되지 않은 단말기 또는 지역에서 접속한 행위 등
                  - 처리한 정보주체 정보: 특정 정보주체에 대하여 과도하게 조회, 다운로드 행위 등
                  - 수행업무: 대량의 개인정보에 대한 조회, 정정, 다운로드, 삭제 행위 등
                  - 기타: 짧은 시간에 하나의 계정으로 여러 지역(IP 주소)에서 접속한 행위 등
                """;
        ...
        item42.description = """
                ▷ 용도에 따라 출력항목을 차등화하여 표시하거나, 마스킹하는 등의 방법을 활용할 수 있다.
                
                ▷ 다수의 개인정보처리시스템 등에서 개인정보를 각기 다른 방식으로 마스킹할 때에는 개인정보취급자가 이용자 개인정보 집합을 구성하여 원본정보를 추론할 수 있으므로 동일한 방식으로 표시제한 조치를 취하여야 한다.
                """;
        ...
        item43.description = """
                ▷ 업무상 반드시 필요한 경우가 아니라면 개인정보 검색 시 like 검색이 되지 않도록 조치한다.
                
                ▷ 개인정보 검색 시에는 불필요하거나 과도한 정보가 조회되지 않도록 일치검색(equal검색) 또는 두 가지 항목 이상의 검색조건을 사용하여야 한다.
                """;
        ...
        item45.description = """
                ▷ 개인정보취급자의 비밀번호 초기화 시, 내부 관리자 시스템의 계정 보안을 강화할 수 있도록 위의 내용을 고려하여 구현해야 한다.
                
                ▷ 비밀번호를 변경할 시에는 아이핀, 휴대폰 본인인증 등 인증수단을 통해 개인정보취급자 본인임을 인증하는 절차를 수행해야 한다.
                """;
        ...
        item47.description = """
                ▷ Credential 객체를 생성하기 위한 패스워드를 소스코드 내부에 하드코딩 하는 경우, 접속 정보가 노출될 수 있어 위험하다.
        ...
        item48.description = """
                ...
                ▷ 개인정보처리시스템의 데이터베이스(DB)에 접속하는 DB관리자의 비밀번호는 복잡하게 구성하고 변경 주기를 짧게 하는 등 강화된 안전조치를 적용할 필요가 있다.
                """;
        ...
        item49.description = """
                ...
                ▷ 로그인 시도횟수를 3~5번 이내로 제한하고 이를 초과하여 로그인에 실패하는 경우 추가 입력 값을 요구하거나 계정 잠금을 수행하도록 설계한다.
                """;
        ...
        item50.description = """
                ▷ 로그인 시도 시 ID와 비밀번호 중 어떤 정보가 잘못된 것인지 알려주는 에러창은 공격자에게 중요한 정보를 제공해서 보안을 약하게 할 수 있다.
                
                ▷ 따라서 로그인 에러창을 띄울 때는 'ID 또는 비밀번호가 틀렸습니다' 등과 같이 아이디와 비밀번호 중 어떤 정보가 잘못된 것인지 알 수 없도록 메시지를 출력해야 한다.
                """;
        ...
        item52.description = """
                ▷ 개인정보(주민등록번호, 여권번호 등), 금융정보(카드번호, 계좌번호 등), 패스워드 등 중요정보를 통신채널로 전송하거나 저장할 때는 반드시 암호화 과정을 거쳐야 한다.
                """;
        ...
        item53.description = """
                ▷ 개인정보(주민등록번호, 여권번호 등), 금융정보(카드번호, 계좌번호 등), 패스워드 등 중요정보를 통신채널로 전송하거나 저장할 때는 반드시 암호화 과정을 거쳐야 한다. 필요한 경우 SSL 또는 HTTPS 등과 같은 암호채널을 사용해야 한다.
                
                ▷ 보조저장매체를 통해 비밀번호, 고유식별정보, 민감정보, 바이오정보, 금융정보를 전달하는 경우에도 암호화하여야 한다.
                """;
        ...
        item54.description = """
                ...
                ▷ HTTP 헤더에 아래와 같이 설정하여 세션 ID 값은 HTTPS를 통해서만 전송되도록 설정하고, 자바스크립트를 통해 세션 ID 값 등 쿠키 정보가 유출되지 않도록 보호한다.
                  - Set-Cookie: Secure; HttpOnly
                
                ▷ 중요정보가 포함되는 쿠키는 암호화하여 전송하거나 HMAC 같은 메시지인증코드를 이용하여 서버 측에서 무결성을 검증한다.
                """;
        ...
        item55.description = """
                ▷ 관리자 페이지 URL이 유추하기 쉬운 이름(admin, manager 등) 및 웹 사이트 설계 오류를 수정하여 비인가자의 관리자 메뉴 접근을 방지한다.
                
                ▷ 서버(Nginx, Apache, Tomcat 등)혹은 클라우드/네트워크 보안 그룹(AWS Security Group, 방화벽, WAF 등)에 ACL을 부여함으로써 권한 없는 사용자로부터의 접근을 방지한다.
                """;
        ...
        item57.description = """
                ...
                ▷ 장기 미접속에 따른 계정 잠금 적용이 필요한 기간은 최소한의 기간으로 설정해야 한다. (일반적으로 30일~90일 이내)
                """;
        ...
        item58.description = """
                ▷ 동일한 계정을 이용하여 동시접속을 수행하는 경우, 한 개의 접속만을 허용하도록 해야 한다.
        ...
        item59.description = """
                ▷ 고유식별정보, 금융정보 등 민감한 개인정보를 표시하는 화면은 웹 브라우저의 뒤로 가기(Back) 버튼을 클릭해서 조회하면 기존 정보가 보이지 않도록 조치해야 한다. (No-Cache 설정 등)
                
                ▷ 개인정보의 출력, 다운로드 등 처리과정에서 개인정보처리 단말기에 임시파일이 저장되지 않도록 조치해야 한다. (불가피하게 생성되는 경우에는 처리 완료 후 완전 삭제되도록 해야 함)
                """;
        ...
        item60.description = """
                ▷ 대화형 웹 사이트에 비정상적인 사용자 입력 값 허용을 차단하여 악의적인 데이터베이스 접근 및 조작을 방지해야 한다.
        ...
        item61.description = """
                ▷ 업로드되는 파일의 확장자에 대한 적절성 여부를 검증하는 로직을 통해 공격자가 조작된 Server Side Script 파일 업로드 방지 및 서버상에 저장된 경로를 유추하여 해당 Server Side Script 파일 실행을 불가능하게 해야 한다.
                """;
        ...
        item62.description = """
                ▷ 파일 다운로드 시 허용된 경로 외 다른 경로의 파일 접근을 방지하여 공격자가 임의의 위치에 있는 파일을 열람하거나 다운받는 것을 불가능하게 해야 한다.
                """;
        ...
        item63.description = """
                ▷ 웹 사이트 내 크로스사이트 스크립팅 취약점을 제거하여 악성 스크립트의 실행을 차단해야 한다.
        ...
        item64.description = """
                ▷ 적절한 검증절차를 거치지 않은 사용자 입력 값에 의해 의도하지 않은 시스템 명령어가 실행되는 것을 방지해야 한다.
                """;
        ...
        item65.description = """
                ▷ 공격자가 폴더의 위치를 예측하여 파일 및 정보 획득을 방지해야 한다.
                
                ▷ 폴더나 파일명의 위치가 예측 가능하여 쉽게 노출될 경우, 공격자는 이를 악용하여 대상에 대한 정보를 획득하고 민감한 데이터에 접근할 수 있게 된다.
                """;
        ...
        item66.description = """
                ▷ 디렉터리 인덱싱 취약점을 제거하여 특정 디렉터리 내 불필요한 파일 정보의 노출을 차단해야 한다.
        ...
        item67.description = """
                ▷ 인증이 필요한 모든 페이지에 대해 유효 세션임을 확인하는 프로세스 및 주요 정보 페이지에 접근 요청자의 권한 검증 로직을 적용하여, 비인가자가 하위 URL 직접 접근, 스크립트 조작 등의 방법으로 중요한 페이지에 접근을 시도하는 것을 차단해야 한다.
                """;
